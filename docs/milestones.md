...
1. Data proof: real SF roads, six snapped landmarks, three or more flagship routes,
   validated export, interactive preview, and passing Python checks.
2. Unreal graybox: versioned JSON load, road/building geometry, vehicle foundation,
   collision-ready road meshes, and automation fixtures. Full editor compile still
